        ...
        <>
            ...
            <section className='w-full bg-three h-fit py-16'>
                ...
                >
                        ...
                        className="bg-[linear-gradient(220.55deg,#565656_0%,#181818_100%)] border rounded-3xl shadow-sm sm:flex dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 mb-5">
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 1 }}
                        className="bg-[linear-gradient(220.55deg,#565656_0%,#181818_100%)] border rounded-3xl shadow-sm sm:flex dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
                            <div className="py-[180px] px-[50px] flex flex-col">
                                <h1 className='text-3xl text-center'>Starting at</h1>
